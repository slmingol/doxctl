...
[![Homebrew](https://img.shields.io/badge/Homebrew-Tap-orange?logo=homebrew)](https://github.com/slmingol/homebrew-tap)
[![Platform](https://img.shields.io/badge/Platform-Linux%20%7C%20macOS-lightgrey)](https://github.com/slmingol/doxctl/releases)
[![Architecture](https://img.shields.io/badge/Arch-amd64%20%7C%20arm64-blue)](https://github.com/slmingol/doxctl/releases)
...
domNameChk: "example.local"
domSearchChk: "[0-1].*example"
domAddrChk: "[0-1].*10.5"

# DNS dig probe servers
domainName: "examplecorp.local"
...
wellKnownSvcs:
  - svc: openshift
    svrs:
      - ocp-master-01{a,b,c}.{lab1,rdu1,dfw1}.examplecorp.local
  - svc: idm
    svrs:
      - idm-01{a,b}.{lab1,rdu1,dfw1,lax2,jfk1}.examplecorp.local
```
