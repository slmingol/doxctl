...
<img src="./imgs/whats_up_dox.png" style="width:1000px;height:200px;display:block;margin-left:auto;margin-right:auto;width:50%;">
...
+ grep -q 'DomainName.*example.local'
+ echo 'DomainName set'
+ echo '<dictionary> {
  DomainName : example.local
  SearchDomains : <array> {
